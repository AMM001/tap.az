...
class AdDetailCell: UICollectionViewCell {
    ...
    let descriptionTextView : UITextView = {
        ...
        view.attributedText = NSMutableAttributedString(string: "...", attributes: [ NSFontAttributeName : UIFont(name: HELVETICA_NEUE_BOLD, size: 14.0)! ,
                                                                                     NSForegroundColorAttributeName : TEXT_COLOR_BLUE ])
        view.contentInset = UIEdgeInsets(top: -2.0 , left: 0.0 , bottom: 0.0 , right: 0.0)
        view.textColor = TEXT_COLOR_BLUE
        return view
    }()
    ...
    fileprivate func setupViews () {
        ...
        let mmkeyboard = MMNumberKeyboard(frame: CGRect.zero)
        mmkeyboard.allowsDecimalPoint = true
        mmkeyboard.delegate = self
        
        self.choosenValueTextFiled.inputView = mmkeyboard
...
extension AdDetailCell : MMNumberKeyboardDelegate  {
